...
const opcionesAdmin = [
  ...
  { texto: "Aulas", icono: MeetingRoomIcon, ruta: "/aulas" },
  { texto: "Períodos académicos", icono: CalendarMonthIcon, ruta: "/periodos" },
...
const opcionesDocente = [
  { texto: "Dashboard", icono: DashboardIcon, ruta: "/dashboard" },
  { texto: "Mi horario", icono: ScheduleIcon, ruta: "/horarios" },
  { texto: "Aulas", icono: MeetingRoomIcon, ruta: "/aulas" },
  { texto: "Períodos académicos", icono: CalendarMonthIcon, ruta: "/periodos" },
];
...
function Sidebar() {
  ...
  const opciones = rol === "ADMIN" ? opcionesAdmin : opcionesDocente;
